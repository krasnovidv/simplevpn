...
function VarStamp() {
  ...
  return (
    <Screen state={state} variant="stamp">
      <Header subtitle={state === 'connected' ? 'Your traffic has been denied by us instead of them' : 'A VPN by you, against them'}/>
...
function VarScanner() {
  ...
  return (
    <Screen state={state} variant="scanner">
      <Header subtitle={state==='connected' ? 'You are nobody. Enjoy.' : 'Operation: Disappear'}/>
      <div onClick={toggle} style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', position: 'relative' }}>
        {/* concentric rings */}
...
function VarGlitch() {
  ...
  return (
    <Screen state={state} variant="glitch">
      ...
      <Header subtitle={state==='connected' ? 'The signal is clean.' : 'Signal compromised'}/>
  ...
  return (
    <div style={{ padding: '20px 24px 0', position: 'relative', zIndex: 2 }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <div style={{ width: 36, height: 36, borderRadius: 18, border: `1px solid ${PAL.dim2}`, display:'flex', alignItems:'center', justifyContent:'center' }}>
